        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketBuyerId = table.Column<int>(nullable: true),
                    OrganisationId = table.Column<int>(nullable: true),
                    IsOrganisation = table.Column<bool>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AppUsers_TicketBuyerId",
                        column: x => x.TicketBuyerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TicketBuyerId",
                table: "AspNetUsers",
                column: "TicketBuyerId");

            migrationBuilder.AddForeignKey(
                name: "FK_Bought_AppUsers_UserId",
                table: "Bought",
                column: "UserId",
                principalTable: "AppUsers",
                principalColumn: "Id",
